...
**Prerequisites**: This guide assumes you have a Kubernetes cluster with GPU nodes and have completed the [Dynamo Platform installation](/kubernetes-deployment/deployment-guide/detailed-installation-guide).
</Callout>
...
- **Dynamo platform installed** with the operator running (see [Installation Guide](/kubernetes-deployment/deployment-guide/detailed-installation-guide))
- **[kube-prometheus-stack](/kubernetes-deployment/observability-k-8-s/metrics) installed and running** (required for SLA planner)
...
For detailed explanations of all configuration options (SLA, hardware, sweep, AIC, planner), see the [DGDR Configuration Reference](/components/planner/sla-driven-profiling#dgdr-configuration-reference).
</Callout>
...
Follow the instructions in [Dynamo Metrics Collection on Kubernetes](../kubernetes/observability/metrics) to access the Grafana UI and select the **Dynamo Planner Dashboard**.
...
For details on hardware configuration and GPU discovery options, see [Hardware Configuration in SLA-Driven Profiling](/components/planner/sla-driven-profiling#hardware-configuration).
...
<Callout intent="info">
For comprehensive troubleshooting including AI Configurator constraints, performance debugging, and backend-specific issues, see [SLA-Driven Profiling Troubleshooting](/components/planner/sla-driven-profiling#troubleshooting).
</Callout>

## Configuration Reference

For comprehensive documentation of all DGDR configuration options, see the [DGDR Configuration Reference](/components/planner/sla-driven-profiling#dgdr-configuration-reference).
...
- [DGDR API Reference](/additional-resources/advanced-kubernetes/api-reference)
- [Pre-Deployment Profiling Details](/components/planner/sla-driven-profiling)
- [SLA Planner Architecture](/components/planner/sla-based-planner)
- [Dynamo Operator Guide](/kubernetes-deployment/deployment-guide/dynamo-operator)
