...
📖 [DynamoModel API Reference](../api_reference#dynamomodel)
...
**📖 [Dynamo CRD API Reference](../api_reference#dynamomodel)**
...
- Check the [API Reference](../api_reference#dynamomodel) for advanced configuration
