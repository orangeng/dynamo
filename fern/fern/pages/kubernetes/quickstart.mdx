...
**Dynamo Namespace**: The logical namespace used by Dynamo components for [service discovery](/additional-resources/advanced-kubernetes/service-discovery).
...
For detailed installation instructions, see the [Prerequisites section](/kubernetes-deployment/deployment-guide/detailed-installation-guide#prerequisites) in the Installation Guide.
...
For more details or customization options (including multinode deployments), see **[Installation Guide for Dynamo Kubernetes Platform](/kubernetes-deployment/deployment-guide/detailed-installation-guide)**.
...
For SLA-based autoscaling, see [SLA Planner Quick Start Guide](/components/planner/sla-planner-quick-start).
...
Refer to the [API Reference and Documentation](/additional-resources/advanced-kubernetes/api-reference) for more details.

## 📖 API Reference & Documentation

For detailed technical specifications of Dynamo's Kubernetes resources:

- **[API Reference](/additional-resources/advanced-kubernetes/api-reference)** - Complete CRD field specifications for all Dynamo resources
- **[Create Deployment](/additional-resources/advanced-kubernetes/create-deployment)** - Step-by-step deployment creation with DynamoGraphDeployment
- **[Operator Guide](/kubernetes-deployment/deployment-guide/dynamo-operator)** - Dynamo operator configuration and management
...
- Auto-discovers backend workers via [service discovery](/additional-resources/advanced-kubernetes/service-discovery) (Kubernetes-native by default)
...
- **[Create Custom Deployments](/additional-resources/advanced-kubernetes/create-deployment)** - Build your own CRDs
- **[Managing Models with DynamoModel](/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model)** - Deploy LoRA adapters and manage models
- **[Operator Documentation](/kubernetes-deployment/deployment-guide/dynamo-operator)** - How the platform works
- **[Service Discovery](/additional-resources/advanced-kubernetes/service-discovery)** - Discovery backends and configuration
- **[Helm Charts](https://github.com/ai-dynamo/dynamo/tree/main/deploy/helm/README.md)** - For advanced users
- **[GitOps Deployment with FluxCD](/additional-resources/advanced-kubernetes/flux-cd)** - For advanced users
- **[Logging](/kubernetes-deployment/observability-k-8-s/logging)** - For logging setup
- **[Multinode Deployment](/kubernetes-deployment/multinode/multinode-deployments)** - For multinode deployment
- **[Grove](/kubernetes-deployment/multinode/grove)** - For grove details and custom installation
- **[Monitoring](/kubernetes-deployment/observability-k-8-s/metrics)** - For monitoring setup
- **[Model Caching with Fluid](/additional-resources/advanced-kubernetes/model-caching-with-fluid)** - For model caching with Fluid
