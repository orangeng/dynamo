...
**New to DGDR and SLA-Driven Profiling?** Start with the [SLA-Driven Profiling and Planner Deployment Quick Start Guide](/components/planner/sla-planner-quick-start) for step-by-step instructions. This document provides deeper technical details about the profiling process.
</Callout>
...
See the [Quick Start Guide](/components/planner/sla-planner-quick-start) for prerequisites and detailed instructions.
...
- **Deploy with DGDR**: See [Quick Start Guide](/components/planner/sla-planner-quick-start)
- **Understand SLA Planner**: Read [SLA Planner Deep Dive](/components/planner/sla-based-planner)
- **Monitor Deployments**: Set up [Observability](/kubernetes-deployment/observability-k-8-s/metrics)
- **Optimize Performance**: See [Performance Tuning](/user-guides/tuning-disaggregated-performance)

## Related Documentation

- [DGDR API Reference](/additional-resources/advanced-kubernetes/api-reference)
- [SLA Planner Quick Start](/components/planner/sla-planner-quick-start)
